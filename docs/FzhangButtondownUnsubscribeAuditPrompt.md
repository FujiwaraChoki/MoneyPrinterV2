...
- 新订阅者会收到确认邮件
- 资源本身当前是站内即时解锁，不是通过邮件交付
- 确认后应进入 Welcome / 后续订阅关系，而不是“资源交付邮件”
...
- 确认邮件为什么可能天然没有退订链接
- 当前 Welcome / 后续主题邮件为什么应该有退订或管理入口

### 任务 2：检查当前站点链路里，Welcome / 后续邮件到底属于哪一类
...
- 要明确区分确认邮件、欢迎邮件、站内资源交付、普通更新邮件的责任边界
