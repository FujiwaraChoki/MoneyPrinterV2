...
POST_BRIDGE_SUPPORTED_PLATFORMS = [
    "youtube",
    "tiktok",
    "instagram",
    "facebook",
...
def get_ollama_base_url() -> str:
    ...
    """
    return load_config().get("ollama_base_url", "http://127.0.0.1:11434")
...
def get_ollama_model() -> str:
    ...
    """
    return load_config().get("ollama_model", "")
...
def get_twitter_language() -> str:
    ...
    """
    return load_config()["twitter_language"]
...
def get_nanobanana2_api_key() -> str:
    ...
    Returns:
        key (str): API key
    """
    configured = load_config().get("nanobanana2_api_key", "")
...
def get_nanobanana2_model() -> str:
    ...
    """
    return load_config().get("nanobanana2_model", "gemini-3.1-flash-image-preview")
...
def get_nanobanana2_aspect_ratio() -> str:
    ...
    """
    return load_config().get("nanobanana2_aspect_ratio", "9:16")
...
def get_is_for_kids() -> bool:
    ...
    """
    return load_config()["is_for_kids"]
...
def get_google_maps_scraper_zip_url() -> str:
    ...
    Returns:
        url (str): The URL to the zip file
    """
    return load_config()["google_maps_scraper"]
...
def get_google_maps_scraper_niche() -> str:
    ...
    Returns:
        niche (str): The niche
    """
    return load_config()["google_maps_scraper_niche"]
...
def get_scraper_timeout() -> int:
    ...
    """
    return load_config()["scraper_timeout"] or 300
...
def get_outreach_message_subject() -> str:
    ...
    """
    return load_config()["outreach_message_subject"]
...
def get_outreach_message_body_file() -> str:
    ...
    """
    return load_config()["outreach_message_body_file"]
...
def get_tts_voice() -> str:
    ...
    """
    return load_config().get("tts_voice", "Jasper")
...
def get_assemblyai_api_key() -> str:
    ...
    """
    return load_config()["assembly_ai_api_key"]
...
def get_stt_provider() -> str:
    ...
    """
    return load_config().get("stt_provider", "local_whisper")
...
def get_whisper_device() -> str:
    ...
    """
    return load_config().get("whisper_device", "auto")
...
def get_whisper_compute_type() -> str:
    ...
    """
    return load_config().get("whisper_compute_type", "int8")
...
def get_imagemagick_path() -> str:
    ...
    """
    return load_config()["imagemagick_path"]
...
def save_config(config: dict) -> None:
    """
    Persists the full application configuration.

    Args:
        config (dict): Config payload to write.
...
def update_config_section(section: str, values: dict) -> dict:
    """
    Merges values into a top-level config section and persists the change.

    Args:
        section (str): Top-level config key.
        values (dict): Values to merge into the section.

    Returns:
        updated (dict): Updated config payload.
    """
    config = load_config()
    ...
    config[section] = merged_values
    save_config(config)
    return config

def get_video_publishing_config() -> dict:
    """
    Gets the config-backed video generation profile.

    Returns:
        config (dict): Sanitized video publishing configuration.
    """
    defaults = {
    ...
    raw_config = load_config().get("video_publishing", {})
    if not isinstance(raw_config, dict):
        raw_config = {}

    return {
        "profile_name": str(
            raw_config.get("profile_name", defaults["profile_name"])
        ).strip() or defaults["profile_name"],
        "niche": str(raw_config.get("niche", defaults["niche"])).strip(),
        "language": str(
            raw_config.get("language", defaults["language"])
        ).strip() or defaults["language"],
    }
...
def get_post_bridge_config() -> dict:
    ...
    supported_platforms = set(POST_BRIDGE_SUPPORTED_PLATFORMS)
    ...
    return {
        ...
        "auto_publish": bool(
            raw_config.get(
                "auto_publish",
                raw_config.get("auto_crosspost", defaults["auto_publish"]),
            )
        ),
    }
