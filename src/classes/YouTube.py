...
class YouTube:
    ...
    def generate_script(self) -> str:
        ...
        """
        prompt = f"""
        Generate a script for a video in {get_script_sentence_length()} sentences, depending on the subject of the video.
        ...
        YOU MUST NOT EXCEED THE {get_script_sentence_length()} SENTENCES LIMIT. MAKE SURE THE {get_script_sentence_length()} SENTENCES ARE SHORT.
